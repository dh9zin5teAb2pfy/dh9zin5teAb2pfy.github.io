// skhb layer bind
const skhbLayers = {
    "flood_layer":"skhb1-layer", // 洪水
    "doseki_layer":"skhb2-layer", // 崖崩れ、土石流、地滑り
    "kyukeisha_layer":"skhb2-layer", // 崖崩れ、土石流、地滑り
    "jisuberi_layer":"skhb2-layer", // 崖崩れ、土石流、地滑り
    "hightide_layer":"skhb3-layer", // 高潮
    "tsunami_layer":"skhb5-layer", // 津波
}
...
class OpacityControl {
    ...
    _radioButtonControlAdd(layerId) {
        ...
        radioButton.addEventListener('change', (event) => {
            ...
            this._map.setLayoutProperty(layerId, 'visibility', 'visible');
            this._map.setLayoutProperty(skhbLayers[layerId], 'visibility', 'visible');
            // 選択レイヤ以外非表示
