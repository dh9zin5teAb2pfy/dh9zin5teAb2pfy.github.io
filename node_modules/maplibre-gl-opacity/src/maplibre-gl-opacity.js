// skhb layer bind
const skhbLayers = {
    "flood_layer":"skhb1_layer", // 洪水
    "hightide_layer":"skhb3_layer", // 高潮
    "tsunami_layer":"skhb5_layer", // 津波
    "doseki_layer":"skhb2_layer", // 崖崩れ、土石流、地滑り
    "kyukeisha_layer":"skhb2_layer", // 崖崩れ、土石流、地滑り
    "jisuberi_layer":"skhb2_layer", // 崖崩れ、土石流、地滑り
}
...
class OpacityControl {
    ...
    _radioButtonControlAdd(layerId) {
        ...
        radioButton.addEventListener('change', (event) => {
            ...
            this._map.setLayoutProperty(layerId, 'visibility', 'visible');
            layerId in skhbLayers ? this._map.setLayoutProperty(skhbLayers[layerId], 'visibility', 'visible') : false;
            // 選択レイヤ以外非表示
            Object.keys(this._baseLayersOption).map((layer) => {
                if (layer !== event.target.id) {
                    ...
                    if (layer in skhbLayers) {
                        if (skhbLayers[layer] != skhbLayers[layerId]) {
                            this._map.setLayoutProperty(skhbLayers[layer], 'visibility', 'none');
                        }
                    }
