        ...
        radioButton.addEventListener('change', (event) => {
            ...
            Object.keys(this._baseLayersOption).map((layer) => {
                if (layer !== event.target.id) {
                    ...
                    layer in skhbLayers ? this._map.setLayoutProperty(skhbLayers[layer], 'visibility', 'none') : false;
                }
            });
        });
        // レイヤ名追加
